<template>
    ...
    <form @submit.prevent="onSubmit" class="border border-5 border-primary rounded ">
        ...
        <br>
         <div class=" col-4" >
            <label  > ادخل نوع فترة الضمان   </label>
...
import VueUploadMultipleImage from 'vue-upload-multiple-image'
  ...
  export default {
    ...
    methods: {
        async onSubmit() {
            this.loading=true;
            let response = await this.Api('POST','services',this.record);
            this.loading=false;
    ...
    computed: {
        ...
        allValidation(){
            return this.validateName_ar && this.validateName_en && this.validatePrice &&
                this.validateWarranty_period  &&   this.validateCtegory  && !this.loading
        }
    },
    async mounted(){
